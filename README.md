...
|Company|WFH|Travel|Visitors|Events|Updated|
|---|---|---|---|---|---|
...
- [Architectural Support for Programming Languages and Operating Systems (ASPLOS)](ASPLOS): cancelled
...
- [Dreamforce World Tour (Sydney)](Sydney): cancelled
...
- [Emerald City Comic Con (ECCC)](ECCC): postponed until summer
...
- [Fast Software Encryption (FSE) 2020](FSE): postponed
- [FIRST Cyber Threat Intelligence Symposium 2020 (FIRST CTI)](FIRST CTI): cancelled
- [FIRST Technical Colloquium 2020 (FIRST TC)](FIRST TC): postponed until next year (2021)
- [Flink Forward (Apache Flink)](Apache Flink): cancelled, considering moving to virtual
- [Game Developers Conference (GDC)](GDC): postponed
...
- [International Conference on Software Engineering (ICSE)](ICSE): postponed to October
...
- [Oracle User Group Irelend (OUG Ireland)](OUG Ireland): cancelled
...
- [Shopify Pursuit (Melbourne and Mexico)](Melbourne and Mexico): postponed, no date given
...
- [Women in Cybersecurity (WiCyS) 2020](WiCyS): cancelled, looking for alternative options TBD
